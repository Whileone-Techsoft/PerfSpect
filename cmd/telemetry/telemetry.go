...
var categories = []common.Category{
	{FlagName: flagCPUName, FlagVar: &flagCPU, DefaultValue: false, Help: "monitor cpu utilization", TableNames: []string{report.CPUUtilizationTelemetryTableName, report.CPUUtilizationHeatmapTableName, report.UtilizationCategoriesTelemetryTableName}},
